ACDiscountApp.PDPage.DisplayTiers = function () {
  ...
  var WriteTableHeading = function (tierObj) {
    ...
    var tableSelector = '.purchase-details button[name="add"]';
      ...
      if (globalFields.settings.selected_table == "table2") {
          ...
          TableHeadHtml('<div class="ac__settings__table ac_table2" id="ac_table2"><div class="ac__tbody"><div class="ac__tr ac__tr1"><th class="ac__th ac__th1">' + globalFields.settings.table_headers.header1_value + '</th><th class="ac__th ac__th2">' + globalFields.settings.table_headers.header2_value + '</th><th class="ac__th ac__th3">' + globalFields.settings.table_headers.header3_value + '</th></div></div></div>', tableSelector);
      }
  ...
  var TableRowSingle = function (tieredMin_, tieredMax_, discountedPrice, tieredOff, index) {
      ...
      if (globalFields.settings.selected_table == "table2") {
          TableRowHtml('<div class="ac__tr ac__tr' + (index + 1) + '"> <span class="ac__td ac__td1">' + tieredMin_ + '</span><span class="ac__td ac__td2">' + tieredMax_ + '</span><span class="ac__td ac__td3">' + tieredOff + '</span></div>', '#ac_table2 .ac__tbody');
      }
